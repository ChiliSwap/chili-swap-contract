...
/**
 * This is a sample contract to be used in the MasterChefChiliSwap contract for partners to reward
...
contract SimpleRewarderPerBlock is IRewarder, BoringOwnable {
    ...
    constructor(
        ...
        require(Address.isContract(address(_MCM)), "constructor: MasterChefChiliSwap must be a valid contract");
    ...
    /// @notice Function called by MasterChefChiliSwap whenever staker claims JOE harvest. Allows staker to also receive a 2nd reward token.
    /// @param _user Address of user
    /// @param _lpAmount Number of LP tokens the user has
    function onChiliSwapReward(address _user, uint256 _lpAmount) external override onlyMCM {
        updatePool();
